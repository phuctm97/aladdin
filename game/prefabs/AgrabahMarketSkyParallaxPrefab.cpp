#include "AgrabahMarketSkyParallaxPrefab.h"
#include "../scripts/DynamicParallaxController.h"

USING_NAMESPACE_ALA;

ALA_CLASS_SOURCE_1(AgrabahMarketSkyParallaxPrefab, ala::PrefabV2)

void AgrabahMarketSkyParallaxPrefab::doInstantiate( ala::GameObject* object, std::istringstream& argsStream ) const {
  // constants
  ...
  float layerOffsets[] = { 29.5f, 58.5f, 78.5f };
