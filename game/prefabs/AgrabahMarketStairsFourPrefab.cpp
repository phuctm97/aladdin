...
void AgrabahMarketStairsFourPrefab::doInstantiate(ala::GameObject* object, std::istringstream& argsStream) const {
	...
	const auto thirdSwitchCollider = new Collider(object, true, Vec2(2090.0f - 2152.5f - 292.5f + 344.5, 120.0f + 87.5f), 
		Size(10, 50), 1, 0, "S");
	...
	new ColliderRenderer(thirdSwitchCollider);*/
	...
	thirdSwitchCollider->setFlags(COLLIDE_ALADDIN_FLAG | STATIC_FLAG);
	thirdSwitchCollider->ignoreIfHasAnyFlags(STATIC_FLAG);
