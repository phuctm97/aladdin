...
void AgrabahMarketStairsFourPrefab::doInstantiate(ala::GameObject* object, std::istringstream& argsStream) const {
	...
	const auto firstSwitchCollider = new Collider(object, true, Vec2(2513.0f - 2445.0f, -33.0f + 87.5), Size(15.0f, 118.0f), 1, 0, "B");
	
	const auto secondSwitchCollider = new Collider(object, true, Vec2(2090.0f - 2152.5f - 292.5f, 33.0f + 87.5f), Size(11.0f, 73.0f), 1, 0, "U");
