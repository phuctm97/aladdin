...
void AgrabahMarketScene::onPreInitialize() {
	...
	gameManager->getPrefabV2( "Agrabah Market Stairs 3" )->instantiateWithArgs( "0", "Stairs 3" )
			   ->getTransform()->setPosition( 2152.5f, 0.0f );*/

	gameManager->getPrefabV2("Agrabah Market Stairs 4")->instantiateWithArgs("0", "Stairs 3")
		->getTransform()->setPosition(2445.0f, -87.5f);
	...
	*/
	...
	devNode->setLayer("Foreground"); */
	//devNode->setTag(ALADDIN_TAG);
	/*devNode->getTransform()->setPosition(0, 0);
